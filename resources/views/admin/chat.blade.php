            ...
            <ul class="nxl-navbar">
                ...
                <li class="nxl-item nxl-hasmenu">
                    <a href="javascript:void(0);" class="nxl-link">
                        ...
                        <span class="nxl-mtext">Chat</span><span class="nxl-arrow"><i class="feather-chevron-right"></i></span>
                    </a>
                </li>
                    ...
                    <div class="content-sidebar-items">
                        <div class="p-4 d-flex position-relative border-bottom c-pointer single-item">
                            <div class="avatar-image">
                                <img src="assets/images/avatar/133.jpg" class="img-fluid" alt="image">
                            </div>
                            <div class="ms-3 item-desc">
                                <div class="w-100 d-flex align-items-center justify-content-between">
                                    <a href="javascript:void(0);" class="hstack gap-2 me-2">
                                        ...
                                        <span class="fs-10 fw-medium text-muted text-uppercase d-none d-sm-block">1 min ago</span>
                                    </a>

                                </div>
                                <p class="fs-12 fw-semibold text-dark mt-2 mb-0 text-truncate-2-line">Biror savolingiz bo'lsa bemalol 24/7 mirojaat qilishingiz mumkin</p>
                            </div>
                        </div>
                        <div class="p-4 d-flex position-relative border-bottom c-pointer single-item">
                            ...
                            <div class="ms-3 item-desc">
                                <div class="w-100 d-flex align-items-center justify-content-between">
                                    <a href="javascript:void(0);" class="hstack gap-2 me-2">
                                        <span>Doktor Murod</span>
                                        <div class="wd-5 ht-5 rounded-circle opacity-75 me-1 bg-success"></div>
                                        <span class="fs-10 fw-medium text-muted text-uppercase d-none d-sm-block">Active now</span>
                                    </a>

                                </div>
                                <p class="fs-12 fw-semibold text-dark mt-2 mb-0 text-truncate-2-line">Qon bosimi va yurak kasalliklari bo'yicha mutaxasis</p>
                            </div>
                        </div>
            ...
            <div class="content-area" data-scrollbar-target="#psScrollbarInit">
                    ...
                    <div class="page-header-left hstack gap-4">
                        ...
                        <a href="javascript:void(0);" class="d-flex align-items-center justify-content-center gap-3" data-bs-toggle="offcanvas" data-bs-target="#userProfileDetails">
                            ...
                            <div class="d-none d-sm-block">
                                <div class="fw-bold d-flex align-items-center">Doktor Murodov</div>
                ...
                <div class="content-area-body">
                    ...
                    <div class="single-chat-item mb-5">
                        <div class="d-flex flex-row-reverse align-items-center gap-3 mb-3">
                            ...
                            <div class="d-flex flex-row-reverse align-items-center gap-2">
                                <a href="javascript:void(0);">Jonibek</a>
                        ...
                        <div class="wd-500 p-3 rounded-5 bg-gray-200 ms-auto">
                            <p class="py-2 px-3 rounded-5 bg-white">Salom doktor</p>
                            <p class="py-2 px-3 rounded-5 bg-white mb-0">Meni qon bosimim tez-tez ko'tarilib turadi. Shunga qanday taomlarni tavsiya qilasiz</p>
                        </div>
                    </div>
                    ...
                    <div class="single-chat-item mb-5">
                        <div class="d-flex align-items-center gap-3 mb-3">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <a href="javascript:void(0);">Doktor Murodov</a>
                                <span class="wd-5 ht-5 bg-gray-400 rounded-circle"></span>
                                <span class="fs-11 text-muted">10:40 PM</span>
                            </div>
                        </div>
                        <div class="wd-500 p-3 rounded-5 bg-gray-200">
                            <p class="py-2 px-3 rounded-5 bg-white">Salom Jonibek</p>
                            <p class="py-2 px-3 rounded-5 bg-white mb-0">Sizni qon bosimi bezovta qilayotgan bo'lsa yog'li va kuchli ovqatlarni kamroq yeyishni tavsiya qilaman.</p>
                        </div>
                    </div>
                    ...
                    <div class="single-chat-item mb-5">
                        ...
                        <div class="wd-500 p-3 rounded-5 bg-gray-200 ms-auto">
                            <p class="py-2 px-3 rounded-5 bg-white">Javob uchun raxmat</p>
                            <p class="py-2 px-3 rounded-5 bg-white">Tavsiyalarizga amal qilishga xarakat qilaman!</p>
                        </div>
                    </div>
                    <!--! END: Single Message [Reply] !-->
    ...
    <div class="offcanvas-body p-0">
        ...
        <div class="p-4 fs-13 collapse show" id="PersonalInfo">
            ...
            <div class="d-flex align-items-start mb-3">
                ...
                <a href="javascript:void(0)">https://www.theme_ocean.com</a>
            </div>
            <div class="d-flex align-items-start mb-3">
                <div class="me-3">
                    <i class="feather-activity"></i>
