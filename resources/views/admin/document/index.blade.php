                            ...
                            <div class="table-responsive table-container">
                                <table class="table table-hover " id="proposalList">
                                    ...
                                    <tr>
                                        ...
                                        <th style="font-weight: bold; font-size: 13px; color: #333;">Юклаган ходим</th>
                                        <th style="font-weight: bold; font-size: 13px; color: #333; text-align: center">Кўриш ёки юклаб олиш</th>
                                            ...
                                            <tr class="single-item">
                                                ...
                                                <td class="text-center">
                                                    <div class="d-inline-flex gap-2">
                                                        <button class="btn btn-primary btn-sm" onclick="openModal('{{ asset('storage/' . $document->file_path) }}')">
                                                            Кўриш
                                                        </button>
                                                    </div>
                                                </td>
